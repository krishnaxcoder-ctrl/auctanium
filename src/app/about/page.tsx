  ...
  return (
    <div className="min-h-screen bg-primary">
      ...
      <div className="mx-auto max-w-8xl px-4 py-8 sm:py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        {/* CTA Section */}
        <div className="relative rounded-2xl overflow-hidden py-16 lg:py-24">
          {/* Background Image */}
          <Image
            src="/background.jpg"
            alt="Background"
          ...
          <div className="relative mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center text-center">
              ...
              {/* Trust Badges */}
              <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
                <div className="flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 transition-all duration-200 hover:bg-white/20">
                  <Shield01 className="size-4 text-brand-200" />
                  <span className="text-xs font-medium text-brand-100">Secure Payments</span>
                </div>
                <div className="flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 transition-all duration-200 hover:bg-white/20">
                  <Award01 className="size-4 text-brand-200" />
                  <span className="text-xs font-medium text-brand-100">Trusted Platform</span>
                </div>
                <div className="flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 transition-all duration-200 hover:bg-white/20">
                  <TrendUp01 className="size-4 text-brand-200" />
                  <span className="text-xs font-medium text-brand-100">Best Deals</span>
                </div>
              </div>
            </div>
          </div>
