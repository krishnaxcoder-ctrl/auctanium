...
const mostViewedProducts: readonly MarketplaceProduct[] = [
    {
        id: "mv-1",
...
export const MostViewedSection = memo(function MostViewedSection() {
        ...
        <section className="bg-primary py-4 lg:py-6 overflow-x-clip">
            <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8 overflow-visible">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/trending" className="flex items-center gap-1 text-sm font-medium text-brand-600 hover:text-brand-700">
                        See All
